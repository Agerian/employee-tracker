...
function viewAllEmployees() {
    db.query(
        'SELECT employee.*, CONCAT(role.id, \': \' , role.title) AS role_id, manager.first_name AS manager_first_name, manager.last_name AS manager_last_name FROM employee LEFT JOIN role ON employee.role_id = role.id LEFT JOIN employee AS manager ON employee.manager_id = manager.id', function (err, results) {
        if (err) {
            console.error(err);
            menu();
            return;
